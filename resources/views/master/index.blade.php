...
<div class="card">
    <div class="card-body">
        ...
        <a href="{{ url('barang/create') }}" class="btn btn-primary mb-4"><i class="fas fa-plus"></i><span class="px-2">Tambah</span></a>
        <a href="/exportexcelbarang" class="btn btn-success mb-4"></i><i class="fas fa-file-excel"></i><span class="px-2">Export</span></a>
